...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($new_password !== $confirm_password) {
        echo "<script>alert('Passwords do not match!'); window.location.href='sreset.html';</script>";
        exit();
    }
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Password reset successful! Redirecting to login...'); window.location.href='student-login.html';</script>";
    } else {
        echo "<script>alert('Something went wrong. Try again!'); window.location.href='sreset.html';</script>";
    }
